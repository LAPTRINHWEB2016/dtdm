...
<t:genericpage>
    ...
    <div class="display" style="float: left; width: 100%;">
        <div class="title_display">
             <a style='color:#666;' href=indexb404.html?TopicId=14491cca-f22a-4b92-82c3-a5bd7f2643eb>call for papers </a> 
        </div>
        <div style="margin-top: 10px;">
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                    <div class="articleTitle">
                        <a href="index789b.html?ArticleId=fc8c1223-a9d2-46b5-9db3-665c778f0ac9"></a>
                    </div>
...
<span style="font-size: 14px; color: #002060;">Submitted papers should be written in English. All submissions must be made electronically in PDF format via the ICSSE2017 website at </span><a href="index.html" re_target="null" target="_blank"><span style="font-size: 14px; color: #00b0f0;">http://icsse2017.hcmute.edu.vn</span></a></span><br />
</span></div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="Telerik.Web.UI.WebResource823b.jpg?type=rca&amp;guid=cbe15170-b8a4-4d8d-a0e4-86b794a836ea" style="height:50px;width:150px;border-width:0px;display:block;" />
